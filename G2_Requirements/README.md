...
![Visual Studio](./x_gitres/visual-studio.png)
![Visual Studio Optionen](./x_gitres/visual-studio-2.png)
...
![Microsoft SQL-Server](./x_gitres/sql-server.png)

Alternativ kann auch MySQL verwendet werden.

![MySQL](./x_gitres/mysql.png)
...
![node js](./x_gitres/node-js.png)

</br>

![node js setup](./x_gitres/node-js-setup.png)
...
![node js setup](./x_gitres/node-js-setup-check.png)
...
![postman setup](./x_gitres/postman-setup.jpg)
